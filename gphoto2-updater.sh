...
echo 
echo "-------------------------"
echo "Downloading libusb 1.0.19"
echo "-------------------------"
echo

if wget -q http://downloads.sourceforge.net/project/libusb/libusb-1.0/libusb-1.0.19/libusb-1.0.19.tar.bz2
	then
		tar xjvf libusbx-1.0.19.tar.bz2
		cd libusb-1.0.19/
	else
		echo "Unable to get libusb_1.0.19"
